...
export type PathSegment = [string, number, number][] | [string][];
...
export class Geometry {
   ...
   *     子路径的 PathSegment
   */
  public subPath(path: string | PathSegment, t1: number, t0: number): PathSegment;
   ...
   *     变换后的路径
   */
  public transformPath(path: string | PathSegment, matrix: Matrix): PathSegment;
}
